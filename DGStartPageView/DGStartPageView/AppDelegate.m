...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"firstLaunch"]) {
        ...
        DGStartPageView *startPageView = [[DGStartPageView alloc]initWithFrame:CGRectMake(0, 0, MainScreen_width, MainScreen_height)];
        
        [self.window.rootViewController.view addSubview:startPageView];
        
        [UIView animateWithDuration:0.25 animations:^{
            startPageView.frame = CGRectMake(0, 0, MainScreen_width, MainScreen_height);
